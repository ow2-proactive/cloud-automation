...
public class OctetStreamWriter implements MessageBodyWriter<ExceptionBean> {
    ...
    @Override
    public long getSize(ExceptionBean t, Class<?> type, Type genericType, Annotation[] annotations,
            MediaType mediaType) {
        return -1;
    }

    @Override
    public void writeTo(ExceptionBean t, Class<?> type, Type genericType, Annotation[] annotations,
