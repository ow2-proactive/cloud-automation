...
import org.ow2.proactive.workflowcatalog.cli.CommandFactory;

public class WcHelpCommand extends AbstractCommand implements Command {

    private static final String USAGE = "USAGE:";

    public WcHelpCommand() {}
    ...
    public void execute(ApplicationContext currentContext) throws CLIException {
        ...
        formatter.printHelp(pw, 110, USAGE, "", CommandFactory
                .getCommandFactory().supportedOptions(), formatter
